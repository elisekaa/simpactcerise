...
void PersonalEventListTesting::processUnsortedEvents(PopulationAlgorithmTesting& alg, PopulationStateTesting& pop,
                                                     double t0)
{
        checkEarliestEvent();
        checkEvents();
                                                         ...
                                                         // number of relationships has been reached
                        {
                                ...
                                for (int k = 0; k < numPersons; k++) {
                                        if (k != respIdx) // only for the secondary lists
                                                personalEventList(pEvt->getPersonWithoutChecking(k))
                                                    ->removeSecondaryEvent(pEvt);
                                }
...
void PersonalEventListTesting::advanceEventTimes(PopulationAlgorithmTesting& alg, const PopulationStateTesting& pop,
                                                 double t1)
{
        checkEarliestEvent();
        checkEvents();
...
void PersonalEventListTesting::adjustingEvent(
