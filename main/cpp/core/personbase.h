 ...
 * directly, but provides some common functions for a class which should derive from it.
 */
class PersonBase
{
public:
        ...
        enum Gender
        {
                Male,
                Female,
                // For internal use: global events will be registered with a 'dummy' person instance.
                GlobalEventPerson
        };
...
public:
        ...
        /// This is only meant to be used by the implementation of an algorithm, and allows you to
        /// store algorithm-specific data for each person (gets deleted automatically in the destructor).
