...
std::string EventStudyStart::getDescription(double tNow) const { return "Study start"; }
...
ConfigFunctions studyStartConfigFunctions(EventStudyStart::processConfig, EventStudyStart::obtainConfig,
                                          "EventStudyStart");
