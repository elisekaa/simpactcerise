...
std::string EventStudyStep::getDescription(double tNow) const { return "Study step"; }
...
void EventStudyStep::writeToLog(double t, const MaxARTPopulation& population, bool start)
{
        ...
        for (int i = 0; i < num; i++) {
                ...
                if (population.getStudyStage() == MaxARTPopulation::InStudy) {
                        ...
                        case Facility::ControlStage: stageName = "C"; break;
                        case Facility::TransitionStage: stageName = "T"; break;
                        case Facility::InterventionStage: stageName = "I"; break;
