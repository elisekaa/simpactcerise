...
EvtHazardFormationAgeGap::EvtHazardFormationAgeGap(const string& hazName, bool msm, double a0, double a1, double a2,
                                                   double a3, double a4, double a5, double a6, double a7, double a8,
                                                   double a9, double a10, double aDist, double b, double tMax)
    : EvtHazard(hazName)
{
        m_msm = msm;
                                                               ...
                                                               const SimpactEvent& event, double t0, double dt)
{
        ...
        const auto& eventFormation = dynamic_cast<const EventFormation&>(event);
...
double EvtHazardFormationAgeGap::getTr(const SimpactPopulation& population, Person* pPerson1, Person* pPerson2,
...
EvtHazard* EvtHazardFormationAgeGap::processConfig(ConfigSettings& config, const string& prefix, const string& hazName,
                                                   bool msm)
{
