...
string EventHIVSeed::getDescription(double tNow) const { return "HIV seeding"; }
...
void EventHIVSeed::obtainConfig(ConfigWriter& config) { EventSeedBase::obtainConfig(s_settings, config, "hivseed"); }
