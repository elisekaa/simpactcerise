...
{
        return strprintf("HSV2 Transmission event from %s to %s", getPerson(0)->getName().c_str(),
...
ConfigFunctions hsv2TransmissionConfigFunctions(EventHSV2Transmission::processConfig,
                                                EventHSV2Transmission::obtainConfig, "EventHSV2Transmission");
