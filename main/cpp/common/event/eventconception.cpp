...
EventConception::EventConception(Person* pPerson1, Person* pPerson2, double relationshipFormationTime)
...
string EventConception::getDescription(double tNow) const { return "Conception"; }
...
ConfigFunctions conceptionConfigFunctions(EventConception::processConfig, EventConception::obtainConfig,
                                          "EventConception");
