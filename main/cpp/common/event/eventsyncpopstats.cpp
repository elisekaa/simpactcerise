...
string EventSyncPopulationStatistics::getDescription(double tNow) const { return "syncpopstats"; }
...
double EventSyncPopulationStatistics::getNewInternalTimeDifference(GslRandomNumberGenerator* pRndGen,
                                                                   const State*              pState)
{
        assert(s_interval > 0);
        return s_interval;
