...
class HazardFormationSimple : public Hazard
{
public:
        ///
...
inline double HazardFormationSimple::getLnB() const
{
...
inline double HazardFormationSimple::getB() const { return std::exp(getLnB()); }

inline double HazardFormationSimple::getC() const
{
        double C = m_a4 + m_b;
        return C;
}

inline double HazardFormationSimple::getE(double t0) const
{
        double Pi  = m_pPerson1->getNumberOfRelationships();
        double Pj  = m_pPerson2->getNumberOfRelationships();
        double tBi = m_pPerson1->getDateOfBirth();
