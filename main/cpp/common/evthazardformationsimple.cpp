...
EvtHazardFormationSimple::EvtHazardFormationSimple(const string& hazName, bool msm, double a0, double a1, double a2,
                                                   double a3, double a4, double a5, double a6, double a7, double aDist,
                                                               ...
                                                               const SimpactEvent& event, double t0, double dt)
{
        ...
        // return ExponentialHazardToInternalTime(pPerson1, pPerson2, t0, dt, tr, a0, m_a1, m_a2, m_a3, m_a4, m_a5,
        // m_Dp, m_b, true, tMax);
}
...
double EvtHazardFormationSimple::getTr(const SimpactPopulation& population, Person* pPerson1, Person* pPerson2,
