...
double EventBase::calculateInternalTimeInterval(const State* pState, double t0, double dt) { return dt; }

double EventBase::solveForRealTimeInterval(const State* pState, double Tdiff, double t0) { return Tdiff; }
