...
{
public:
        DiscreteDistribution2D(double xOffset, double yOffset, double xSize, double ySize, const GridValues& density,
                               bool floor, GslRandomNumberGenerator* pRngGen, const Polygon2D& filter = Polygon2D());
