 ...
 *
 *  The probability density is the following: \f[ \textrm{prob}(x) = \frac{a+b}{\Gamma(a)\Gamma(b)}
 * \left(\frac{x-min}{max-min}\right)^{a-1} \left( 1 - \frac{x-min}{max-min} \right)^{b-1} \frac{1}{max-min} \f]
 */
