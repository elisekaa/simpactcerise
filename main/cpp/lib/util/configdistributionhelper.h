 ...
 *
 *  Beta distribution, \f[ \textrm{prob}(x) = \frac{a+b}{\Gamma(a)\Gamma(b)} \left(\frac{x-min}{max-min}\right)^{a-1}
 * \left( 1 - \frac{x-min}{max-min} \right)^{b-1} \frac{1}{max-min} \f]
 *
 *   - test.dist.type = beta
 *   - test.dist.beta.a = 2
 *   - test.dist.beta.b = 2
 ...
 *   - test.dist.gamma.b = 1
 *
 *  Log-normal distribution, \f[ \textrm{prob}(x) = \frac{1}{x s \sqrt{2 \pi} } \exp\left(-\frac{(\textrm{ln}(x)-z)^2}{2
 * s^2}\right) \f]
 *
 ...
 *
 *  Normal distribution, \f[ \textrm{prob}(x) = \frac{1}{\sigma \sqrt{2 \pi} }  \exp\left(-\frac{(x-\mu)^2}{2
 * \sigma^2}\right) \f]
 *
