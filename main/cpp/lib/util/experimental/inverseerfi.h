...
private:
        ...
        static double estimateFromTable(gsl_root_fsolver* pSolver, double x, double realX, double* pTable,
                                        double binWidth, bool isLogTable);
        static double solveWithGSL(gsl_root_fsolver* pSolver, double y, double x_lo = 0, double x_hi = 25,
                                   double tolerance = 0);
