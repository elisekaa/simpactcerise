...
{
public:
        HazardFunctionFormationSimple(const Person* pPerson1, const Person* pPerson2, double tr, double a0, double a1,
...
inline double HazardFunctionFormationSimple::getB() const { return std::exp(getLnB()); }
