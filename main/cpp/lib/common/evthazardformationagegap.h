...
{
public:
        EvtHazardFormationAgeGap(const std::string& hazName, bool msm, double a0, double a1, double a2, double a3,
                                 double a4, double a5, double a6, double a7, double a8, double a9, double a10,
                                 double aDist, double b, double tMax);
