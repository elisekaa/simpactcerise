...
{
public:
        EvtHazardFormationAgeGapRefYear(const std::string& hazName, bool msm, double a0, double a1, double a2,
                                        double a3, double a4, double a6, double a7, double a8, double a10, double aDist,
                                        double agfmConst, double agfmExp, double agfmAge, double agfwConst,
                                        double agfwExp, double agfwAge, double numRelScaleMan, double numRelScaleWoman,
                                        double b, double tMax, double maxRefYearDiff);
...
private:
        ...
        double getTr(const SimpactPopulation& population, Person* pPerson1, Person* pPerson2, double t0,
                     double lastDissTime);
