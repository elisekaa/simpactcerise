...
string EventHSV2Seed::getDescription(double tNow) const { return "HSV2 seeding"; }
...
void EventHSV2Seed::obtainConfig(ConfigWriter& config) { EventSeedBase::obtainConfig(s_settings, config, "hsv2seed"); }
