...
void SimpactEvent::writeEventLogStart(bool noExtraInfo, const std::string& eventName, double t, const Person* pPerson1,
                                      const Person* pPerson2)
{
        ...
        if (noExtraInfo)
                LogEvent.print(format.c_str(), t, eventName.c_str(), name1.c_str(), id1, gender1, age1, name2.c_str(),
                               id2, gender2, age2);
        else
                LogEvent.printNoNewLine(format.c_str(), t, eventName.c_str(), name1.c_str(), id1, gender1, age1,
                                        name2.c_str(), id2, gender2, age2);
}
