...
void Person::writeToPersonLog()
{
        ...
        double treatmentTime =
            (m_hiv.isInfected() && m_hiv.hasLoweredViralLoad()) ? m_hiv.getLastTreatmentStartTime() : infinity;
        ...
        LogPerson.print("%d,%d,%10.10f,%10.10f,%d,%d,%10.10f,%10.10f,%10.10f,%10.10f,%d,%d,%10.10f,%10.10f,%10.10f,%10."
                        "10f,%d,%10.10f,%d,%10.10f,%10.10f",
                        id, gender, timeOfBirth, timeOfDeath, fatherID, motherID, debutTime, formationEagerness,
                        formationEagernessMSM, infectionTime, origin, infectionType, log10SPVLoriginal, treatmentTime,
                        m_location.x, m_location.y, aidsDeath, hsv2InfectionTime, hsv2origin, cd4AtInfection,
                        cd4AtDeath);
}
