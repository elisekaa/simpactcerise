...
public:
        ...
        bool_t getKeyValue(const std::string& key, std::string& value,
        ...
        bool_t getKeyValue(const std::string& key, double& value,
        ...
        /** Interprets the value for the specified key as an integer number,
         *  checking that it lies withing the bounds if specified. */
        bool_t getKeyValue(const std::string& key, int64_t& value,
