...
inline double inv_erf(double x) { return gsl_cdf_gaussian_Pinv(0.5 * (x + 1.0), ONE_OVER_SQRT_TWO); }

inline double inv_erfc(double x) { return gsl_cdf_gaussian_Qinv(0.5 * x, ONE_OVER_SQRT_TWO); }
