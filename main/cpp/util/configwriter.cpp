...
bool_t ConfigWriter::addKey(const std::string& key, double value) { return addKey(key, doubleToString(value)); }

bool_t ConfigWriter::addKey(const std::string& key, int value) { return addKey(key, strprintf("%d", value)); }

bool_t ConfigWriter::addKey(const std::string& key, int64_t value) { return addKey(key, strprintf("%" PRId64, value)); }
...
bool_t ConfigWriter::addKey(const std::string& key, const char* pStr) { return addKey(key, string(pStr)); }
