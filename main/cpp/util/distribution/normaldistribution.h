 ...
 *
 *  The probability density is based on the following: \f[ \textrm{prob}(x) = \frac{1}{\sigma \sqrt{2 \pi} }
 * \exp\left(-\frac{(x-\mu)^2}{2 \sigma^2}\right) \f] The range is restricted to the specified [min,max] range by using
 *  rejection sampling.
 */
