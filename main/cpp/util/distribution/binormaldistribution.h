...
{
public:
        BinormalDistribution(double mu, double sigma, double rho, GslRandomNumberGenerator* pRndGen,
...
private:
        ...
        double pickConditional(double val, double meanDest, double meanCond, double sigmaDest, double sigmaCond,
