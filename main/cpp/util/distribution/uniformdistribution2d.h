...
inline UniformDistribution2D::UniformDistribution2D(double minValueX, double maxValueX, double minValueY,
                                                    double maxValueY, GslRandomNumberGenerator* pRng)
    : ProbabilityDistribution2D(pRng, true), m_xDist(minValueX, maxValueX, pRng), m_yDist(minValueY, maxValueY, pRng)
