...
CMAKE_INSTALL_PREFIX  = $(HOME)/opt/simpact-$(LABEL)
...
help:
	...
	@ $(CMAKE) -E echo " "
	@ $(CMAKE) -E echo "   SIMPACT_INCLUDE_DOC           : " $(SIMPACT_INCLUDE_DOC)
	@ $(CMAKE) -E echo "   SIMPACT_FORCE_NO_OPENMP       : " $(SIMPACT_FORCE_NO_OPENMP)
	@ $(CMAKE) -E echo " "
